...
<div align="justify">
<i><b>Olá</b> :wave:, sou o <code>Aramuni</code>, tenho 34 anos, moro em BH e sou programador desde os 15 anos de idade.<br/>
Atualmente sou <code>professor</code> nos cursos de Engenharia de Software e Ciência da Computação da <a href="https://www.pucminas.br/" target="_blank">PUC Minas</a>.</i> :man_teacher:
</div>
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        <div>
          ⭐ Nominate a Star:<br />
          <p>💡 Ajude a reconhecer meu trabalho open source!<br /></p>
          <p> 🚀 Se você gosta dos meus projetos de código aberto, considere me indicar para o programa <b>GitHub Stars</b>!<br />
          🌐 O programa destaca desenvolvedores que contribuem ativamente com a comunidade open source no GitHub.<br /></p>
          <p> 🔗 <b>Indique aqui:</b> <a href="https://stars.github.com/nominate/" target="_blank">https://stars.github.com/nominate/</a><br />
          📈 Somando todos os meus repositórios, já compartilhei mais de <b>250.000 linhas de código</b> com a comunidade.</p>
