...
| ${\color{orange}08:50-10:30}$ | (COREU) Projeto de Software |--|--|--|--|
| ${\color{orange}10:40-12:20}$ | (COREU) Laboratório de Desenvolvmento de Software |--|--| (COREU) Projeto de Software |--|
| ${\color{orange}17:00-19:00}$ |--|OFICINAS|OFICINAS|--|OFICINAS|
| ${\color{orange}19:00-20:40}$ | (COREU) TIS3 - Aplicações para cenários reais | (LOURDES) Fundamentos de Projeto e Análise de Algoritmos |--| (COREU) Projeto de Software | (LOURDES) Laboratório de Desenvolvimento de Software G2 |
