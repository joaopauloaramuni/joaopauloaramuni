...
| ${\color{darkorange}15:20-16:10}$ | ${\color{olive}(LOURDES)}$ TI:II - FRONT-END |--|--| ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software/tree/main/PROJETOS" target="_blank">SpringBoot</a> | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> |
| ${\color{darkorange}16:10-17:00}$ | ${\color{olive}(LOURDES)}$ TI:II - FRONT-END | ${\color{coral}TEAMS-AES/CTOs}$ | ${\color{olive}(LOURDES)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO TCCII</a> | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software/tree/main/PROJETOS" target="_blank">SpringBoot</a> | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> |
