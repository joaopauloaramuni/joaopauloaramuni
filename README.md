...
| ${\color{orange}10:40-12:20}$ | ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software" target="_blank">Laboratório de Desenvolvmento de Software</a> |--|--| ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/projeto-de-software" target="_blank">Projeto de Software</a> |${\color{peachpuff}ORIENTAÇÃO/MENTORIA/DÚVIDAS}$|
