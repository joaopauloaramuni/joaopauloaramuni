...
| ${\color{orange}10:40-12:20}$ | ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software" target="_blank">Laboratório de Desenvolvmento de Software</a> |--|--| ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/projeto-de-software" target="_blank">Projeto de Software</a> |<a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO</a>|
| ${\color{orange}17:00-18:00}$ |--|${\color{cyan}OFICINAS}$|${\color{cyan}OFICINAS}$|--|${\color{cyan}OFICINAS}$|
| ${\color{orange}18:00-19:00}$ |--|${\color{cyan}OFICINAS}$|${\color{cyan}OFICINAS}$|--|${\color{peachpuff}REUNIÃO}$|
