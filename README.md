...
| ${\color{darkorange}Horário}$ | ${\color{darkorange}Segunda}$ | ${\color{darkorange}Terça}$ | ${\color{darkorange}Quarta}$ | ${\color{darkorange}Quinta}$ | ${\color{darkorange}Sexta}$ |
|-------------|------------|------------|------------|------------|------------|
| ${\color{darkorange}07:00-08:40}$ |--|--| ${\color{olive}(LOURDES)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO TCCII</a> | ${\color{violet}(COREU)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO TCCII</a> | ${\color{olive}(LOURDES)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-de-interfaces-web" target="_blank">CC - Desenvolvimento de Interfaces Web G3</a> |
| ${\color{darkorange}08:50-10:30}$ |--| ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-de-interfaces-web" target="_blank">CC - Desenvolvimento de Interfaces Web G2</a> |--|--| ${\color{olive}(LOURDES)}$ CC - TI:II - FRONT-END |
| ${\color{darkorange}10:40-12:20}$ | ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G3</a> |--| ${\color{olive}(LOURDES)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G2</a> | ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G2</a> |--|
| ${\color{darkorange}15:20-16:10}$ | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software/tree/main/PROJETOS" target="_blank">SpringBoot</a> |--|--| ${\color{violet}(COREU)}$ CC - TI:II - FRONT-END | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> |
| ${\color{darkorange}16:10-17:00}$ | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software/tree/main/PROJETOS" target="_blank">SpringBoot</a> | ${\color{coral}TEAMS-AES/CTOs}$ |--| ${\color{violet}(COREU)}$ CC - TI:II - FRONT-END | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> |
...
| ${\color{darkorange}19:00-20:40}$ | ${\color{olive}(LOURDES)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G1</a> |--|--|--|--|
