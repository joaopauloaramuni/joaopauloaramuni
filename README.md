...
| ${\color{peachpuff}18:00-19:00}$ | ${\color{coral}TEAMS-AES/CTOs}$ |--| ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/algoritmos-e-estruturas-de-dados-i" target="_blank">Aulões de AEDSI</a> |${\color{cyan}OFICINAS}$|${\color{coral}TEAMS-AES/TLs}$|
