...
| ${\color{darkorange}19:00-20:40}$ | ${\color{olive}(LOURDES)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G1</a> | ${\color{violet}(COREU)}$ TI:V - Aplicações Distribuídas |--|--|--|
