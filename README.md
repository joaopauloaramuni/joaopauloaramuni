...
| ${\color{darkorange}Horário}$ | ${\color{darkorange}Segunda}$ | ${\color{darkorange}Terça}$ | ${\color{darkorange}Quarta}$ | ${\color{darkorange}Quinta}$ | ${\color{darkorange}Sexta}$ |
|-------------|------------|------------|------------|------------|------------|
| ${\color{darkorange}07:00-08:40}$ |--|--|--|--| AULA CC |
| ${\color{darkorange}08:50-10:30}$ |--|--|--|--| AULA CC |
...
| ${\color{darkorange}15:20-16:10}$ | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software/tree/main/PROJETOS" target="_blank">SpringBoot</a> |--|--| ${\color{olive}(LOURDES)}$ TI:II - FRONT-END | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> |
| ${\color{darkorange}16:10-17:00}$ | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software/tree/main/PROJETOS" target="_blank">SpringBoot</a> | ${\color{coral}TEAMS-AES/CTOs}$ | ${\color{olive}(LOURDES)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO TCCII</a> | ${\color{olive}(LOURDES)}$ TI:II - FRONT-END | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> |
| ${\color{darkorange}17:00-18:00}$ |--|--|--| ${\color{violet}(COREU)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO TCCII</a> | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/algoritmos-e-estruturas-de-dados-i/tree/main/PROJETOS" target="_blank">Aulões de AEDSI</a> |
