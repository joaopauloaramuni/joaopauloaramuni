...
| ${\color{darkorange}Horário}$ | ${\color{darkorange}Segunda}$ | ${\color{darkorange}Terça}$ | ${\color{darkorange}Quarta}$ | ${\color{darkorange}Quinta}$ | ${\color{darkorange}Sexta}$ |
|-------------|------------|------------|------------|------------|------------|
| ${\color{darkorange}07:00-08:40}$ | ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G2</a> |--|--|--|--|
| ${\color{darkorange}08:50-10:30}$ |--|--|--|--|--|
| ${\color{darkorange}10:40-12:20}$ |--| ${\color{olive}(LOURDES)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G3</a> | ${\color{olive}(LOURDES)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G2</a> | ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G3</a> |--|
| ${\color{darkorange}16:00-17:00}$ | ${\color{coral}TEAMS-AES/CTOs}$ |--| ${\color{olive}(LOURDES)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO TCCII</a> | ${\color{violet}(COREU)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO TCCII</a> | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/algoritmos-e-estruturas-de-dados-i/tree/main/PROJETOS" target="_blank">Aulões de AEDSI</a> |
| ${\color{darkorange}17:00-18:00}$ | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software/tree/main/PROJETOS" target="_blank">SpringBoot</a> |--|--|--| ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> |
| ${\color{darkorange}17:10-18:50}$ |--| ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G2</a> | ${\color{olive}(LOURDES)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G2</a> | ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G3</a> |--|
| ${\color{darkorange}18:00-19:00}$ | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software/tree/main/PROJETOS" target="_blank">SpringBoot</a> |--|--|--| ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> |
...
| ${\color{darkorange}20:50-22:30}$ | ${\color{olive}(LOURDES)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento de Interfaces Web G3</a> | ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G1</a> |--|--| ${\color{olive}(LOURDES)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-e-integracao-de-aplicacoes-web" target="_blank">Desenvolvimento e Integração de Aplicações Web G3</a> |
