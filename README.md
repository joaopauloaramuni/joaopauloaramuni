...
| ${\color{peachpuff}17:00-18:00}$ |--|${\color{cyan}OFICINAS}$|${\color{olive}(LOURDES)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO</a>|--|${\color{cyan}OFICINAS}$|
| ${\color{peachpuff}18:00-19:00}$ |${\color{coral}REUNIÃO-AES/PM}$|${\color{cyan}OFICINAS}$|${\color{olive}(LOURDES)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO</a>|--|${\color{coral}REUNIÃO-AES/CG}$|
