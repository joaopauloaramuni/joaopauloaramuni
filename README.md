...
| ${\color{darkorange}08:50-10:30}$ |--| ${\color{violet}(COREU)}$ <a href="https://github.com/joaopauloaramuni/desenvolvimento-de-interfaces-web" target="_blank">CC - Desenvolvimento de Interfaces Web G1</a> |--|--| ${\color{olive}(LOURDES)}$ CC - <a href="https://github.com/joaopauloaramuni/trabalho-interdisciplinar-front-end"target="_blank"> Trabalho Interdisciplinar: Front-End</a>TI:II - FRONT-END</a> |
