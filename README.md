...
| ${\color{peachpuff}17:00-18:00}$ | ${\color{olive}(LOURDES)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO TCCII</a> |--| ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/algoritmos-e-estruturas-de-dados-i" target="_blank">Aulões de AEDSI</a> | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software/tree/main/PROJETOS" target="_blank">Spring Boot</a> |
...
| ${\color{peachpuff}18:00-19:00}$ | ${\color{coral}TEAMS-AES/CTOs}$ |--| ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/algoritmos-e-estruturas-de-dados-i" target="_blank">Aulões de AEDSI</a> | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> |${\color{coral}TEAMS-AES/TLs}$|
