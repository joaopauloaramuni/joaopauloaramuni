...
| ${\color{peachpuff}18:00-19:00}$ | ${\color{coral}REUNIÃO-AES/CTOs}$|${\color{cyan}OFICINAS}$| ${\color{olive}(LOURDES)}$ <a href="https://calendly.com/aramuni/" target="_blank">ORIENTAÇÃO TCCII</a>|${\color{cyan}OFICINAS}$|${\color{coral}REUNIÃO-AES/TLs}$|
