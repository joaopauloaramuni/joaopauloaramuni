...
| ${\color{darkorange}13:30-15:10}$ |--| ${\color{violet}(COREU)}$ CC - ${\color{cyan}OFICINAS}$ |--|--| ${\color{olive}(LOURDES)}$ CC - ${\color{cyan}OFICINAS}$ |
| ${\color{darkorange}15:20-17:00}$ | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-software/tree/main/PROJETOS" target="_blank">SpringBoot</a> | ${\color{coral}TEAMS-AES/CTOs}$ |--| ${\color{violet}(COREU)}$ CC - TI:II - FRONT-END | ${\color{cyan}OFICINAS}$ <a href="https://github.com/joaopauloaramuni/python/tree/main/PROJETOS" target="_blank">DevLabs</a> |
